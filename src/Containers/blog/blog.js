...
const blog = () => {
  return (
    <div className="gpt3__blod section__padding" id="blog">
      ...
      <div className="gpt3__blog-container">
        <div className="gpt3__blog-container_groupA">
                <Article imgUrl={blog01} date="Sep 26, 2021" text="GPT-3 and Open  AI is the future. Let us exlore how it is?"/></div>
